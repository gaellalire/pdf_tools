...
public class PdfPadesSigner {
    ...
    public String temporaryDirectoryPath = null;
    private IExternalDigest externalDigest = new BouncyCastleDigest();
    public StampingProperties stampingProperties = new StampingProperties().useAppendMode();
    public StampingProperties stampingPropertiesWithMetaInfo = (StampingProperties) new StampingProperties()
    ...
    public void performLtvVerification(PdfDocument pdfDocument, List<String> signatureNames,
    ...
    public void createRevocationClients(Certificate signingCert, boolean clientsRequired) {
    ...
    public void performSignDetached(SignerProperties signerProperties, boolean isFinal,
